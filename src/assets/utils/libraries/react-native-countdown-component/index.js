...
const DEFAULT_DIGIT_STYLE = {backgroundColor: '#EDE9E8', marginHorizontal: 10, padding: 0, height: 45, width: 45};
const DEFAULT_DIGIT_TXT_STYLE = {color: '#000'};
const DEFAULT_TIME_LABEL_STYLE = {color: '#000', marginBottom: 20};
